...
$datatable['json_data'] = [
    ["data" => "title", "name" => "mt_dashboard.title"],
    ["data" => "source", "name" => "mt_dashboard.source"],
    ["data" => "type", "name" => "mt_dashboard.type"],
    ["data" => "active_flag", "name" => "mt_dashboard.active_flag"],
    ["data" => "updated_by_name", "name" => "updated_by.name"],
    ["data" => "updated_at", "name" => "mt_dashboard.updated_at"],
    ["data" => "action", "name" => "action", "orderable" => false, "searchable" => false],
];

$datatable['route_data'] = route('master.dashboard.get_data');
$datatable['route_insert'] = route('master.dashboard.insert');
                ...
                $.ajax({
                    ...
                    success: function(response){
                        if(response.status === 'OK'){
                            ...
                            window.location.href = "{{ route('master.dashboard.list') }}";
                        } else {
