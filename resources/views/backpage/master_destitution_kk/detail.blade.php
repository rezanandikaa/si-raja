...
$datatable['route_data'] = route('master.destitution_kk.bnba.get_data', ['id' => $data['_parent_id']]);
// $datatable['route_back'] = route('master.destitution_kk.list');
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">P3KE Kepala Keluarga</li>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row m-b-10">
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <small class="text-muted">Prioritas Verval: </small>
                                        <p>{{ get_option($data['datas']['priority_verval_id']) }}</p>
                                        <small class="text-muted">Kepemilikan Rumah: </small>
                                        <p>{{ get_option($data['datas']['home_ownership_id']) }}</p>
                                        <small class="text-muted">Memiliki Simpanan/Uang/Perhiasan/Ternak/Lainnya: </small>
                                        <p>{{ get_option($data['datas']['etc_ownership_id']) }}</p>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <ul class="list-group">
                                ...
                                <div class="row clearfix">
                                    <div class="col-12 col-lg-4 col-md-12 col-sm-12">
                                        <div class="card top_counter">
                                            <div class="body">
                                                <div class="icon text-warning"><i class="fa-solid fa-house-chimney"></i></div>
                                                <div class="content">
                                                    <div class="text text-dots"><small>JENIS ATAP - KUALITAS</small></div>
                                                    <h6 class="text">{{ get_option($data['datas']['home_roof_id']) }} - {{ get_option($data['datas']['home_roof_quality_id']) }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-4 col-md-12 col-sm-12">
                                        <div class="card top_counter">
                                            <div class="body">
                                                <div class="icon text-danger"><i class="fa-solid fa-igloo"></i></div>
                                                <div class="content">
                                                    <div class="text text-dots"><small>JENIS DINDING - KUALITAS</small></div>
                                                    <h6 class="text">{{ get_option($data['datas']['home_wall_id']) }} - {{ get_option($data['datas']['home_wall_quality_id']) }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-4 col-md-12 col-sm-12">
                                        <div class="card top_counter">
                                            <div class="body">
                                                <div class="icon text-success"><i class="fa fa-th-large"></i></div>
                                                <div class="content">
                                                    <div class="text text-dots"><small>JENIS LANTAI - KUALITAS</small></div>
                                                    <h6 class="text">{{ get_option($data['datas']['home_floor_id']) }} - {{ get_option($data['datas']['home_floor_quality_id']) }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-4 col-md-12 col-sm-12">
                                        <div class="card top_counter">
                                            <div class="body">
                                                <div class="icon text-primary"><i class="fa-solid fa-faucet-drip"></i></div>
                                                <div class="content">
                                                    <div class="text text-dots"><small>SUMBER AIR MINUM</small></div>
                                                    <h6 class="text">{{ get_option($data['datas']['home_water_id']) }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-4 col-md-12 col-sm-12">
                                        <div class="card top_counter">
                                            <div class="body">
                                                <div class="icon text-danger"><i class="fa-solid fa-toilet"></i></div>
                                                <div class="content">
                                                    <div class="text text-dots"><small>FASILITAS BUANG AIR BESAR</small></div>
                                                    <h6 class="text">{{ get_option($data['datas']['home_toilet_ownership_id']) }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-4 col-md-12 col-sm-12">
                                        <div class="card top_counter">
                                            <div class="body">
                                                <div class="icon text-success"><i class="fa-solid fa-person-breastfeeding"></i></div>
                                                <div class="content">
                                                    <div class="text text-dots"><small>RESIKO STUNTING</small></div>
                                                    <h6 class="text">{{ get_option($data['datas']['stunting_risk_id']) }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
