...
$datatable['json_data'] = [
    ["data" => "title", "name" => "tr_gallery.title"],
    ["data" => "category", "name" => "tr_gallery.category"],
    ["data" => "active_flag", "name" => "tr_gallery.active_flag"],
    ["data" => "updated_by_name", "name" => "updated_by.name"],
    ["data" => "updated_at", "name" => "tr_gallery.updated_at"],
    ["data" => "action", "name" => "action", "orderable" => false, "searchable" => false],
];

$datatable['route_data'] = route('gallery.get_data');
$datatable['route_insert'] = route('gallery.insert');
