...
$datatable['json_data'] = [
    ["data" => "data_name", "name" => "sy_data.name"],
    ["data" => "p3ke", "name" => "mt_destitution_nik.p3ke"],
    ["data" => "last_update_year", "name" => "mt_destitution_nik.last_update_year"],
    ...
    ["data" => "nik", "name" => "mt_destitution_nik.nik"],
    ["data" => "name", "name" => "mt_destitution_nik.name"],
    ["data" => "decile", "name" => "mt_destitution_nik.decile"],
    ["data" => "percentile", "name" => "mt_destitution_nik.percentile"],
    ["data" => "updated_by_name", "name" => "updated_by.name"],
    ["data" => "updated_at", "name" => "mt_destitution_nik.updated_at"],
    ["data" => "action", "name" => "action", "orderable" => false, "searchable" => false],
];

$datatable['route_data'] = route('master.destitution_nik.get_data');
$datatable['route_insert'] = route('master.destitution_nik.insert');
