...
<script>
    $(document).ready(function() {
        ...
        var table = $('.js-basic-datatable').DataTable({
            processing: true,
            serverSide: true,
            // ajax: "{{ route('master.destitution_nik.get_data', ['kemdagri_code' => $data['data']['kemdagri_code']]) }}",
            ajax: {
                url: "{{ route('master.destitution_nik.get_data', ['kemdagri_code' => $data['data']['kemdagri_code']]) }}",
            ...
            columns: [{
                ...
                {
                    data: "p3ke",
                    name: "mt_destitution_nik.p3ke"
                },
                {
                    data: "last_update_year",
                    name: "mt_destitution_nik.last_update_year"
                },
                {
                ...
                {
                    data: "nik",
                    name: "mt_destitution_nik.nik"
                },
                {
                    data: "name",
                    name: "mt_destitution_nik.name"
                },
                {
                    data: "decile",
                    name: "mt_destitution_nik.decile"
                },
                {
                    data: "percentile",
                    name: "mt_destitution_nik.percentile"
                },
                {
                ...
                {
                    data: "updated_at",
                    name: "mt_destitution_nik.updated_at"
                },
                {
                    data: "action",
                    name: "action",
        ...
        $('#action_bpnt').on('click', '.card', function() {
            var settings = table.settings();
            var newData = {
                condition: 'mt_destitution_nik.is_bpnt = 1'
            };
            settings[0].ajax.data = newData;
            swal({
                title: "Konfirmasi!",
        ...
        $('#action_bpum').on('click', '.card', function() {
            var settings = table.settings();
            var newData = {
                condition: 'mt_destitution_nik.is_bpum = 1'
            };
            settings[0].ajax.data = newData;
            swal({
                title: "Konfirmasi!",
        ...
        $('#action_bst').on('click', '.card', function() {
            var settings = table.settings();
            var newData = {
                condition: 'mt_destitution_nik.is_bst = 1'
            };
            settings[0].ajax.data = newData;
            swal({
                title: "Konfirmasi!",
        ...
        $('#action_pkh').on('click', '.card', function() {
            var settings = table.settings();
            var newData = {
                condition: 'mt_destitution_nik.is_pkh = 1'
            };
            settings[0].ajax.data = newData;
            swal({
                title: "Konfirmasi!",
        ...
        $('#action_sembako').on('click', '.card', function() {
            var settings = table.settings();
            var newData = {
                condition: 'mt_destitution_nik.is_sembako = 1'
            };
            settings[0].ajax.data = newData;
            swal({
                title: "Konfirmasi!",
        ...
        $('#action_prakerja').on('click', '.card', function() {
            var settings = table.settings();
            var newData = {
                condition: 'mt_destitution_nik.is_prakerja = 1'
            };
            settings[0].ajax.data = newData;
            swal({
                title: "Konfirmasi!",
        ...
        $('#action_kur').on('click', '.card', function() {
            var settings = table.settings();
            var newData = {
                condition: 'mt_destitution_nik.is_kur = 1'
            };
            settings[0].ajax.data = newData;
            swal({
                title: "Konfirmasi!",
                        ...
                        point: {
                            events: {
                                click: function() {
                                    ...
                                    window.location.href = '{{ route("bnba.detail", ["source" => "nik"]) }}?kemdagri_code=' + this.properties['hc-key'];
                                }
                            }
                        }
                    }],
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="d-flex flex-row-reverse">
                        <div class="page_action">
                            <a href="{{ route('bnba.detail', ['source' => 'nik', 'kemdagri_code' => $data['data']['back_kemdagri_code']]) }}" class="btn btn-danger"><i class="fa-solid fa-chevron-left"></i> Kembali</a>
                        </div>
                ...
                <div class="card top_widget">
                    <div class="body">
                        ...
                        <div class="content">
                            ...
                            <small class="text-muted">Individu Tercatat di Sistem</small>
                        </div>
                    </div>
                </div>
            </div>
