...
<script>
    $(document).ready(function() {
        ...
        var table = $('.js-basic-datatable').DataTable({
            processing: true,
            serverSide: true,
            // ajax: "{{ route('program.get_data', ['kemdagri_code' => $data['data']['kemdagri_code']]) }}",
            ajax: {
                url: "{{ route('program.get_data', ['kemdagri_code' => $data['data']['kemdagri_code']]) }}",
            ...
            columns: [{
                    data: "budget_year_name",
                    name: "mt_budget_year.name"
                },
                {
                    data: "code",
                    name: "tr_program.code"
                },
                {
                    data: "district_name",
                    name: "district.name"
                ...
                {
                    data: "strategy_program_name",
                    name: "program_goal.value"
                },
                {
                    data: "organization_name",
                    name: "mt_organization.name"
                },
                {
                    data: "program",
                    name: "tr_program.program"
                },
                {
                    data: "activity",
                    name: "tr_program.activity"
                },
                {
                    data: "sub_activity",
                    name: "tr_program.sub_activity"
                },
                {
                    data: "status",
                    name: "tr_program.status"
                },
                {
                    data: "budget_allocation",
                    name: "tr_program.budget_allocation"
                },
                {
                    data: "budget_realization",
                    name: "tr_program.budget_realization"
                },
                {
                    data: "percentage",
                    name: "percentage"
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        var newData = {
                            limit_org: 0,
                            condition: 'tr_program.status = "ACTIVE"'
                        };
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        var newData = {
                            limit_org: 0,
                            condition: 'tr_program.status = "DRAFT"'
                        };
                        settings[0].ajax.data = newData;
                        table.ajax.reload();
                    },
        ...
        @foreach($data['strategies'] as $key => $item)
        $('#action_strategy_{{$key + 1}}').on('click', '.card', function() {
            var settings = table.settings();
            var newData = {
                limit_org: 0,
                condition: 'tr_program.program_goal_id = "{{$item['
                id ']}}"'
            };
            settings[0].ajax.data = newData;
            swal({
                        ...
                        point: {
                            events: {
                                click: function() {
                                    ...
                                    window.location.href = '{{ route("bnba.detail", ["source" => "program"]) }}?kemdagri_code=' + this.properties['hc-key'];
                                }
                            }
                        }
                    }],
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="d-flex flex-row-reverse">
                        <div class="page_action">
                            <a href="{{ route('bnba.detail', ['source' => 'program', 'kemdagri_code' => $data['data']['back_kemdagri_code']]) }}" class="btn btn-danger"><i class="fa-solid fa-chevron-left"></i> Kembali</a>
                        </div>
                ...
                <div class="card top_widget">
                    <div class="body">
                        ...
                        <div class="content">
                            ...
                            <small class="text-muted">Program Tercatat di Sistem</small>
                        </div>
                    </div>
                </div>
            </div>
            @foreach ($data['strategies'] as $key => $item)
            <div id="action_strategy_{{ $key + 1}}" class="col-lg-3 col-md-6 col-sm-6">
                <div class="card top_widget">
                    <div class="body">
                        ...
                        <div class="content">
                            ...
                            {{-- <h4 class="number mb-0">3,251 <span class="font-12 text-muted"><i class="fa fa-level-up"></i> 13%</span></h4> --}}
                            <h4 class="number mb-0">{{ $data['data']['total_strategy_'. $key + 1] }}</h4>
                            <small class="text-muted">Program Tercatat di Sistem</small>
                        </div>
                    </div>
                </div>
