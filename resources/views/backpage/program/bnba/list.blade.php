...
$datatable['json_data'] = [
    ["data" => "nik", "name" => "tr_program_realization_bnba.nik"],
    ["data" => "bnba_type_name", "name" => "bnba_type.value"],
    ["data" => "updated_by_name", "name" => "updated_by.name"],
    ["data" => "updated_at", "name" => "tr_program.updated_at"],
    ["data" => "action", "name" => "action", "orderable" => false, "searchable" => false],
];

$datatable['route_data'] = route('program.realization.bnba.get_data', ['id' => $data['_parent_id']]);
$datatable['route_insert'] = route('program.realization.bnba.insert', ['id' => $data['_parent_id']]);
