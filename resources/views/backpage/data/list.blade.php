...
$datatable['json_data'] = [
    ["data" => "name", "name" => "sy_data.name"],
    ["data" => "description", "name" => "sy_data.description"],
    ["data" => "active_flag", "name" => "sy_data.active_flag"],
    ["data" => "updated_by_name", "name" => "updated_by.name"],
    ["data" => "updated_at", "name" => "sy_data.updated_at"],
    ["data" => "action", "name" => "action", "orderable" => false, "searchable" => false],
];

$datatable['route_data'] = route('system.data.get_data');
$datatable['route_insert'] = route('system.data.insert');
