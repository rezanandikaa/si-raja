...
$datatable['json_data'] = [
    ...
    ["data" => "user_access_desc", "name" => "mt_user_access.user_access_desc"],
    ["data" => "updated_by_name", "name" => "updated_by.name"],
    ["data" => "updated_at", "name" => "mt_user_access.updated_at"],
    ["data" => "action", "name" => "action", "orderable" => false, "searchable" => false],
];

$datatable['route_data'] = route('master.user_access.get_data');
$datatable['route_insert'] = route('master.user_access.insert');
