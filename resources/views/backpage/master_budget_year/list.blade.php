...
$datatable['json_data'] = [
    ["data" => "name", "name" => "mt_budget_year.name"],
    ["data" => "updated_by_name", "name" => "updated_by.name"],
    ["data" => "updated_at", "name" => "mt_budget_year.updated_at"],
    ["data" => "action", "name" => "action", "orderable" => false, "searchable" => false],
];

$datatable['route_data'] = route('master.budget_year.get_data');
$datatable['route_insert'] = route('master.budget_year.insert');
