...
$datatable['json_data'] = [
    ["data" => "batch_code", "name" => "sy_file.batch_code"],
    ["data" => "file_name_original", "name" => "sy_file.file_name_original"],
    ["data" => "type", "name" => "sy_file.type"],
    ["data" => "size", "name" => "sy_file.size"],
    ["data" => "updated_by_name", "name" => "updated_by.name"],
    ["data" => "updated_at", "name" => "sy_file.updated_at"],
    ["data" => "action", "name" => "action", "orderable" => false, "searchable" => false],
];

$datatable['route_data'] = route('system.file.get_data');
$datatable['route_insert'] = route('system.file.insert');
                ...
                $.ajax({
                    ...
                    success: function(response){
                        if(response.status === 'OK'){
                            ...
                            window.location.href = "{{ route('system.file.list') }}";
                        } else {
