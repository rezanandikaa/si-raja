...
$datatable['json_data'] = [
    ...
    ["data" => "email", "name" => "mt_user.email"],
    ["data" => "user_access_name", "name" => "mt_user_access.user_access_name"],
    ["data" => "active_flag", "name" => "mt_user.active_flag"],
    ["data" => "organization_name", "name" => "mt_organization.name"],
    ["data" => "updated_by_name", "name" => "updated_by.name"],
    ["data" => "updated_at", "name" => "mt_user.updated_at"],
    ["data" => "action", "name" => "action", "orderable" => false, "searchable" => false],
];

$datatable['route_data'] = route('master.user.get_data');
$datatable['route_insert'] = route('master.user.insert');
...
$(document).ready(function () {
    $('.js-basic-datatable tbody').on('click', 'a.reset', function () {
        ...
        swal({
            ...
            text: "Anda yakin akan pulihkan sandi akun ini ?",
            type: "warning",
            ...
            if (isConfirm) {
                ...
                swal("Dibatalkan", "Sandi tidak jadi diubah", "error");
            }
        });
    });
});
