...
$datatable['json_data'] = [
    ["data" => "name", "name" => "sy_preference.name"],
    ["data" => "key", "name" => "sy_preference.key"],
    ["data" => "value", "name" => "sy_preference.value"],
    ["data" => "updated_by_name", "name" => "updated_by.name"],
    ["data" => "updated_at", "name" => "sy_preference.updated_at"],
    ["data" => "action", "name" => "action", "orderable" => false, "searchable" => false],
];

$datatable['route_data'] = route('system.preference.get_data');
$datatable['route_insert'] = route('system.preference.insert');
