...
$datatable['json_data'] = [
    ["data" => "code", "name" => "sy_option.code"],
    ["data" => "label", "name" => "sy_option.label"],
    ["data" => "value", "name" => "sy_option.value"],
    ["data" => "updated_by_name", "name" => "updated_by.name"],
    ["data" => "updated_at", "name" => "sy_option.updated_at"],
    ["data" => "action", "name" => "action", "orderable" => false, "searchable" => false],
];

$datatable['route_data'] = route('system.option.get_data');
$datatable['route_insert'] = route('system.option.insert');
