...
$datatable['json_data'] = [
    ["data" => "code", "name" => "mt_organization.code"],
    ["data" => "name", "name" => "mt_organization.name"],
    ["data" => "parent_name", "name" => "parent.name"],
    ["data" => "updated_by_name", "name" => "updated_by.name"],
    ["data" => "updated_at", "name" => "mt_organization.updated_at"],
    ["data" => "action", "name" => "action", "orderable" => false, "searchable" => false],
];

$datatable['route_data'] = route('master.organization.get_data');
$datatable['route_insert'] = route('master.organization.insert');
