<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Diisi dengan jumlah rumah tangga/individu dan/atau kelompok masyarakat yang menjadi sasaran program dan kegiatan</td>
            <td>Diisi dengan kendala pelaksanaan program kegiatan PPKE</td>
            <td>Diisi dengan nilai bantuan yang diberikan ke setiap penerima manfaat</td>
            <td>Diisi dengan informasi durasi pemberian bantuan (misal: setiap bulan, per triwulan dll)</td>
        ...
        @foreach($data as $record)
            <tr>
                <td>{{ $i }}</td>
                <td>{{ $record['program_goal_value'] }}</td>
                <td>{{ $record['organization_name'] }}</td>
                <td>{{ $record['program_code'] }}</td>
                <td>{{ $record['program_program'] }}</td>
                <td>{{ $record['program_sub_activity'] }}</td>
                <td>{{ $record['program_budget_allocation'] }}</td>
                ...
                <td>{{ $record['target'] }}</td>
                <td>{{ $record['implementation_obstacle'] }}</td>
                <td>{{ $record['benefit'] }}</td>
                <td>{{ $record['duration_note'] }}</td>
